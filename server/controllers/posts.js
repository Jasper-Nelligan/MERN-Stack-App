/*
 * Contains all handlers for routes. Each route handler could be written in
 * the post-routes.js file, but writing the handler logic in this file keeps
 * post-routes.js cleaner.
 */
